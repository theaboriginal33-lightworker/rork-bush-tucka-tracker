...
console.log("https://vynorjorxebyvuyxnntd.supabase.co", process.env.EXPO_PUBLIC_SUPABASE_URL);
console.log("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ5bm9yam9yeGVieXZ1eXhubnRkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njk5NzQ0NjYsImV4cCI6MjA4NTU1MDQ2Nn0.GtexN1CtNL2mkIbSwQOevwSPiLUSVC9IKXNI-B9AG3U", process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY?.slice(0, 10));
